...
DisplaceControls = function ( camera, domElement ) {
	...
	this.setfocus = function ( object ) {
		...
		_DisplaceFocused = object; this.focusedpart = _DisplaceFocused;
	...
	this.select = function ( object ) {
		...
		_DisplaceMouseOvered = object; this.mouseoveredpart = _DisplaceMouseOvered;
		if ( object.userData.parent ) { // console.log( ' select object3D ' );
...
//DisplaceControls.prototype = Object.create( THREE.EventDispatcher.prototype );
